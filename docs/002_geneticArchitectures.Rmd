...
u<-plot.pc.reps("^parent-courter-nogenetics_\\d+_summary.txt",cols, make.plot = FALSE)
l<-plot.pc.reps("^parent-courter_\\d+_summary.txt",cols,make.plot=FALSE)
s<-plot.pc.reps("^parent-courter_supergene_\\d+_summary.txt",cols,make.plot=FALSE)
...
```{r courtParent_unlinked, echo=FALSE,out.extra='',fig.pos="H",fig.cap="Morph freqs with unlinked SNPs",fig.width=480,fig.height=800}
...
```{r courtParent_supergenes, echo=FALSE,out.extra='',fig.pos="H",fig.cap="Morph freqs with supergenes"}
