...
#propQTL_plot(gwas_summary[gwas_summary$Architecture=="supergene",],cols)
```
...
write.csv(final_freqs,"../results/morph_freqs_summary.csv")
```
...
```{r}
par(mfrow=c(1,2),mar=c(5,5,2,2))
plot(overall_info$P[overall_info$Traits=="Parent"],
     overall_info$PropQTL[overall_info$Traits=="Parent"],
     col=cols["parent"],
     pch=19,
...
plot(overall_info$NON[overall_info$Traits=="Courter"],
     overall_info$PropQTL[overall_info$Traits=="Courter"],
     col=cols["courter"],
     pch=19,
