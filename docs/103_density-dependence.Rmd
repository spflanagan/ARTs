...
```{r unlinked_courter,out.extra='',fig.pos="H", fig.cap="Frequency of the courter morph with unlinked additive genetic variances (each color represents a different replicate)"}
...
```{r,fig.pos="H",fig.cap="Evolution of courtship trait with unlinked loci",fig.width=6,fig.height=10}
...
out<-lapply(cu,function(rep.summ){
  ...
  lines(rep.summ$Generation,rep.summ$CourterAEmean-rep.summ$CourterAEsd,type="l",col=alpha(cols["courter"],0.5),lty=3)
  abline(h=rep.summ$CourterThresh[1],lty=2,col=cols["courter"])
})
```
...
```{r unlinked_courter_nv,out.extra='',fig.pos="H", fig.cap="Frequency of the courter morph with unlinked additive genetic variances and without viability selection (each color represents a different replicate)"}
...
```{r,fig.pos="H",fig.cap="Evolution of courtship trait with unlinked loci and no viability selection",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
out<-lapply(cu,function(rep.summ){
  plot(rep.summ$Generation,rep.summ$CourterAEmean,type="l",col=cols["courter"])
  lines(rep.summ$Generation,rep.summ$CourterAEmean+rep.summ$CourterAEsd,type="l",col=alpha(cols["courter"],0.5),lty=3)
...
```{r parent_nogenetics_traits ,out.extra='',fig.pos="H",fig.cap="Evolution of parenting trait values with additive genetic variation",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
out<-lapply(pu,function(rep.summ){
  ...
  lines(rep.summ$Generation,rep.summ$ParentAEmean-rep.summ$ParentAEsd,type="l",col=alpha(cols["parent"],0.5),lty=3)
  abline(h=rep.summ$CourterThresh[1],lty=2,col=cols["parent"])
})
```

#### Without viability selection

```{r parental_nogenetics_nv, echo=FALSE,out.extra='',fig.pos="H",fig.cap="Frequency of parent morph with unlinked loci without viability selection (each color represents a different replicate)"}
...
```{r parent_nogenetics_traits_nv ,out.extra='',fig.pos="H",fig.cap="Evolution of parenting trait values with additive genetic variation and no viability selection",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
out<-lapply(pu,function(rep.summ){
  plot(rep.summ$Generation,rep.summ$ParentAEmean,type="l",col=cols["parent"])
  lines(rep.summ$Generation,rep.summ$ParentAEmean+rep.summ$ParentAEsd,type="l",col=alpha(cols["parent"],0.5),lty=3)
...
```{r courtparent_traits_unlinked,out.extra='',fig.pos="H",fig.cap="Evolution of the courter and parenting trait values in each rep with unlinked genetic variation",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
...
```{r courtparent_traits_unlinked_nv,out.extra='',fig.pos="H",fig.cap="Evolution of the courter and parenting trait values in each rep with unlinked genetic variation and without viability selection",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
out<-lapply(u,function(rep.summ){
  plot(rep.summ$Generation,rep.summ$ParentAEmean,type="l",col=cols["parent"],
       ylim=c(min(rep.summ$ParentAEmean,rep.summ$CourterAEmean)-0.1,
...
```{r,fig.pos="H",fig.cap="Evolution of courtship trait with linked loci",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
...
```{r,fig.pos="H",fig.cap="Evolution of courtship trait with linked loci and without viability selection",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
out<-lapply(cl,function(rep.summ){
  plot(rep.summ$Generation,rep.summ$CourterAEmean,type="l",col=cols["courter"])
  lines(rep.summ$Generation,rep.summ$CourterAEmean+rep.summ$CourterAEsd,type="l",col=alpha(cols["courter"],0.5),lty=3)
...
```{r parent_linkedgenetics_traits ,out.extra='',fig.pos="H",fig.cap="Evolution of parenting trait values with linked QTLs",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
...
```{r parent_linkedgenetics_traits_nv ,out.extra='',fig.pos="H",fig.cap="Evolution of parenting trait values with linked QTLs and without viability selection",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
out<-lapply(pl,function(rep.summ){
  plot(rep.summ$Generation,rep.summ$ParentAEmean,type="l",col=cols["parent"])
  lines(rep.summ$Generation,rep.summ$ParentAEmean+rep.summ$ParentAEsd,type="l",col=alpha(cols["parent"],0.5),lty=3)
...
Of the `r length(cs)` replicates, `r length(unlist(lapply(cs,nrow))[unlist(lapply(cs,nrow))==10000])` reached an equilibrium by 10000 generations.
...
```{r,fig.pos="H",fig.cap="Evolution of courtship trait with a supergene",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
out<-lapply(cu,function(rep.summ){
  plot(rep.summ$Generation,rep.summ$CourterAEmean,type="l",col=cols["courter"])
  lines(rep.summ$Generation,rep.summ$CourterAEmean+rep.summ$CourterAEsd,type="l",col=alpha(cols["courter"],0.5),lty=3)
...
```{r,fig.pos="H",fig.cap="Evolution of courtship trait with a supergene and without viability selection",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
out<-lapply(cu,function(rep.summ){
  plot(rep.summ$Generation,rep.summ$CourterAEmean,type="l",col=cols["courter"])
  lines(rep.summ$Generation,rep.summ$CourterAEmean+rep.summ$CourterAEsd,type="l",col=alpha(cols["courter"],0.5),lty=3)
...
```{r parent_supergene_traits ,out.extra='',fig.pos="H",fig.cap="Evolution of parenting trait values with a supergene",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
out<-lapply(pl,function(rep.summ){
  plot(rep.summ$Generation,rep.summ$ParentAEmean,type="l",col=cols["parent"])
  lines(rep.summ$Generation,rep.summ$ParentAEmean+rep.summ$ParentAEsd,type="l",col=alpha(cols["parent"],0.5),lty=3)
...
```{r parent_supergene_traits_nv ,out.extra='',fig.pos="H",fig.cap="Evolution of parenting trait values with a supergene without viability selection",fig.width=6,fig.height=10}
par(mfrow=c(5,4),mar=c(1,1,1,1),oma=c(2,2,2,2))
out<-lapply(pl,function(rep.summ){
  plot(rep.summ$Generation,rep.summ$ParentAEmean,type="l",col=cols["parent"])
  lines(rep.summ$Generation,rep.summ$ParentAEmean+rep.summ$ParentAEsd,type="l",col=alpha(cols["parent"],0.5),lty=3)
