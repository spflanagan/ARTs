...
```{r unlinked_courter,out.extra=''}
cu<-plot.courter.reps(pattern="^courter_unlinked_[1-5]_summary.txt",cols,make.plot=FALSE)
```
...
pu<-plot.parent.reps("^parent_unlinked_[1-5]_summary.txt",cols,make.plot=FALSE)
```
...
u<-plot.pc.reps("^parent-courter_unlinked_[1-5]_summary.txt",cols,make.plot=FALSE)
```
...
If we look at how the two traits evolved, it's interesting to note that the same outcomes can emerge from different averages relative to the thresholds. 
...
cl<-plot.courter.reps(pattern="^courter_linked_[1-5]_summary.txt",cols,make.plot=FALSE)
```
...
pl<-plot.parent.reps(pattern="^parent_linked_[1-5]_summary.txt",cols,make.plot=FALSE)
```
...
l<-plot.pc.reps("^parent-courter_linked_[1-5]_summary.txt",cols,make.plot=FALSE)
```
...
cs<-plot.courter.reps(pattern="^courter_supergene_[1-5]_summary.txt",cols,make.plot=FALSE)
```
...
pss<-plot.parent.reps(pattern="^parent_supergene_[1-5]_summary.txt",cols,make.plot=FALSE)
```
...
s<-plot.pc.reps("^parent-courter_supergene_[1-5]_summary.txt",cols,make.plot=FALSE,make.plot=FALSE)
```
