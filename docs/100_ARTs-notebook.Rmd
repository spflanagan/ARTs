...
I realize now that outputting the number randomly mated to stdout doesn't make life easy, and that I should instead save it to the summary file -- so I'll change that. In the meantime, though, I can sift through the log to see if I can make sense of anything.
