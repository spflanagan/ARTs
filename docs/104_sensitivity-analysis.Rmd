...
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_.*",path="baseline",4,cols)
```
...
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_polygyny.*",path="sensitivity",4,cols)
```
...
```{r,fig.cap="Allele frequencies in the final generation of all of the runs - courter RS = 2, noncourter RS = 8",fig.height=10,fig.width=8.5}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_crs2_ncrs8.*",path="sensitivity",4,cols)
```


```{r,fig.cap="Allele frequencies in the final generation of all of the runs - courter RS = 4, noncourter RS = 8",fig.height=10,fig.width=8.5}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_crs4_ncrs8.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - courter RS = 8, noncourter RS = 2",fig.height=10,fig.width=8.5}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_crs8_ncrs8.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - courter RS = 8, noncourter RS = 8",fig.height=10,fig.width=8.5}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_crs8_ncrs8.*",path="sensitivity",4,cols)
```
...
```{r,fig.cap="Allele frequencies in the final generation of all of the runs - parent nest survival = 0.5",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_psurv0.5.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - parent nest survival = 0.6",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_psurv0.6.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - parent nest survival = 0.7",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_psurv0.7.*",path="sensitivity",4,cols)
```
...
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_psurv0.8.*",path="sensitivity",4,cols)
```
...
```{r,fig.cap="Allele frequencies in the final generation of all of the runs - non-parental nest survival = 0.2",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_npsurv0.2.*",path="sensitivity",4,cols)
```


```{r,fig.cap="Allele frequencies in the final generation of all of the runs - non-parental nest survival = 0.3",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_npsurv0.3.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - non-parental nest survival = 0.4",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_npsurv0.4.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - non-parental nest survival = 0.5",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_linked_npsurv0.5.*",path="sensitivity",4,cols)
```
...
```{r,fig.cap="Allele frequencies in the final generation of all of the runs - baseline",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_.*",path="baseline",4,cols)
```
...
```{r,fig.cap="Allele frequencies in the final generation of all of the runs - polygyny",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_polygyny.*",path="sensitivity",4,cols)
```
...
```{r,fig.cap="Allele frequencies in the final generation of all of the runs - supergene and courter RS = 2, noncourter RS = 8",fig.height=10,fig.width=8.5}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_crs2_ncrs8.*",path="sensitivity",4,cols)
```


```{r,fig.cap="Allele frequencies in the final generation of all of the runs - supergene and courter RS = 4, noncourter RS = 8",fig.height=10,fig.width=8.5}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_crs4_ncrs8.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - supergene and courter RS = 8, noncourter RS = 2",fig.height=10,fig.width=8.5}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_crs8_ncrs8.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - supergene and courter RS = 8, noncourter RS = 8",fig.height=10,fig.width=8.5}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_crs8_ncrs8.*",path="sensitivity",4,cols)
```
...
```{r,fig.cap="Allele frequencies in the final generation of all of the runs - parent nest survival = 0.5",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_psurv0.5.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - parent nest survival = 0.6",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_psurv0.6.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - parent nest survival = 0.7",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_psurv0.7.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - parent nest survival = 0.8",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_psurv0.8.*",path="sensitivity",4,cols)
```
...
```{r,fig.cap="Allele frequencies in the final generation of all of the runs - non-parental nest survival = 0.2",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_npsurv0.2.*",path="sensitivity",4,cols)
```


```{r,fig.cap="Allele frequencies in the final generation of all of the runs - non-parental nest survival = 0.3",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_npsurv0.3.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - non-parental nest survival = 0.4",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_npsurv0.4.*",path="sensitivity",4,cols)
```

```{r,fig.cap="Allele frequencies in the final generation of all of the runs - non-parental nest survival = 0.5",fig.height=10,fig.width=8}
all_af_dat<-hists_final_af(base_pattern="^parent-courter_supergene_npsurv0.5.*",path="sensitivity",4,cols)
```
...
* Look into distribution of additive genetic variance/allelic effects
