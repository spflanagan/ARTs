...
Courting males are maintained at a frequency around 80% in these cases and parental males are around 20%. This is surprising - males who are courters and parents should rise to the top, and both should be maintained at a fairly high frequency. Let's look at the reproductive success of the morphs over time.
...
plot(pcng.traits$Courter,pcng.traits$Parent,cex=pcng.traits$LifetimeRS)
library(lattice)
library(viridisLite)
rscol<-plasma(100,direction=-1)
levelplot(pcng.traits$LifetimeRS ~ pcng.traits$Courter*pcng.traits$Parent,
  xlab = "Courter", ylab = "Parent",
  main = "Reproductive Success",
  col.regions = rscol
)
#could also use image(), maybe
```
