...
```{r fitnessPlotFXN}
fitness_plot<-function(fitness_dat,cols2){
...
# High diversity, QTLS
hq<-fitness_plot(fitness_dat[grep("qtls//high",names(fitness_dat))], cols2)
mtext("QTLs, high diversity",3)

# High diversity, supergene
hs<-fitness_plot(fitness_dat[grep("supergene//high",names(fitness_dat))], cols2)
mtext("supergene, high diversity",3)

# Low diversity, QTLS
lq<-fitness_plot(fitness_dat[grep("qtls//low",names(fitness_dat))], cols2)
mtext("QTLs, low diversity",3)

# Low diversity, supergene
ls<-fitness_plot(fitness_dat[grep("supergene//low",names(fitness_dat))], cols2)
