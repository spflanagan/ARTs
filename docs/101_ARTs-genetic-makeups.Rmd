...
The relationship between selection gradients at generation 0 and generation 12000 follow a roughly uniform distribution (Fig. \@ref(fig:gensSelectionCorHist)) -- there is no pattern. However, the direction of selection in the start of the simulations predicts the diversity of the morphs (Fig. \@ref(fig:selFreq)).
