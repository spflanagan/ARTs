...
source("~/Dropbox (UC Enterprise)/Research/ARTs/morph_predictions/check_freqs.R")
source("~/Dropbox (UC Enterprise)/Research/ARTs/morph_predictions/morph_gens_ns.R")
...
```{r lowDivGenetics}
lowDiv<-get.morph.freqs(plot.pc.reps(pattern="lowDiversity.*summary.txt",
...
```{r highDivGenetics}
lowDiv<-get.morph.freqs(plot.pc.reps(pattern="highDiversity.*summary.txt",
                                     path="/mnt/BigData/fixedART-results/qtls",
                                     cols,make.plot=FALSE))
lnames<-rownames(lowDiv)
```
