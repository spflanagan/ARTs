...
Are parent QTLS more likely to be picked up because CP/CN is the most common polymorphism or is it because selection on parents is stronger than selection on courters? To asnwer this, we can summarize the final frequencies and compare those to the prop QTL detected (Fig. \@ref(fig:freqsDetection)).
