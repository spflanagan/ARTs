...
<!-- ```{r unlinked_parent_courtship_pref,echo=FALSE, fig.keep=FALSE} -->
<!-- s<-plot.pc.reps(pattern="^parent-courter-pref-nogenetics_\\d+_summary.txt",cols) -->
<!-- ``` -->
<!-- ```{r unlinked_pc_pref_plotMorphs,echo=FALSE, fig.cap="Frequency of four morphs per rep",fig.height=10,fig.width=6} -->
<!-- plot.morphs.reps(s,cols2,ncols = 4) -->
<!-- ``` -->
