...
plot.pref.freqs(cpref,col=cols["cpref"])
...
cpref.freqs<-get.pref.freqs(cpref)
...
plot.pref.freqs(ppref,cols["ppref"],ylabel = "Frequency of Preference for Parents")

ppref.freqs<-get.pref.freqs(ppref)
...
plot.pref.freqs(pcpref,cols["cpref"],ylabel = "Frequency of Preference for Courters")

pcpref.freqs<-get.pref.freqs(pcpref)
