...
```{r courter_alleleFreqs, echo=FALSE,out.extra='',fig.pos="H",fig.cap="Major allele frequencies in the final generation of each replicate, with QTLs marked with purple stars"}
files<-list.files(pattern="^courter_\\d+_summary.txt")

mycols <- colorRampPalette(c("grey",cols["courter"],"black"))(5)
maf<-plot.final.maf(files,mycols[c(2,4)],"CourterQTL")
```
...
```{r parent_alleleFreqs, echo=FALSE,out.extra='',fig.pos="H",fig.cap="Major allele frequencies in the final generation of each replicate, with QTLs marked with purple stars"}
files<-list.files(pattern="^parent_\\d+_summary.txt")

mycols <- colorRampPalette(c("grey",cols["parent"],"black"))(5)
maf<-plot.final.maf(files,mycols[c(2,4)],"ParentQTL")
```
...
```{r courterParent_alleleFreqs, echo=FALSE,out.extra='',fig.pos="H",fig.cap="Major allele frequencies in the final generation of each replicate, with courter QTLs marked with green stars and parent QTLs marked with blue stars"}
files<-list.files(pattern="^courter_\\d+_summary.txt")

mycols <- colorRampPalette(c("grey","black"))(5)
maf<-plot.final.maf(files,mycols[c(2,4)],"CourterQTL",qtl.name2 = "ParentQTL",
                    qtl.col=cols["courter"],qtl.col2=cols["parent"])
```
...
```{r courterNFDS_alleleFreqs, echo=FALSE,out.extra='',fig.pos="H",fig.cap="Major allele frequencies in the final generation of each replicate, with QTLs marked with purple stars"}
...
```{r, echo=FALSE,out.extra='',fig.pos="H",fig.cap="Major allele frequencies in the final generation of each replicate, with courter QTLs marked with green stars and parent QTLs marked with blue stars"}
...
```{r courterPref_alleleFreqs, echo=FALSE,out.extra='',fig.pos="H",fig.cap="Major allele frequencies in the final generation of each replicate, with QTLs marked with purple stars"}
...
```{r parentPref_alleleFreqs, echo=FALSE,out.extra='',fig.pos="H",fig.cap="Major allele frequencies in the final generation of each replicate, with QTLs marked with purple stars"}
