...
cu<-plot.courter.reps(pattern="^courter_unlinked_\\d+_summary.txt",cols)
```
...
pu<-plot.parent.reps("^parent_unlinked_\\d+_summary.txt",cols)
```
...
u<-plot.pc.reps("^parent-courter_unlinked_\\d+_summary.txt",cols)
```
...
cl<-plot.courter.reps(pattern="^courter_linked_\\d+_summary.txt",cols)
```
...
pl<-plot.parent.reps(pattern="^parent_linked_\\d+_summary.txt",cols)
```
...
l<-plot.pc.reps("^parent-courter_linked_\\d+_summary.txt",cols)
```
...
cs<-plot.courter.reps(pattern="^courter_supergene_\\d+_summary.txt",cols)
```
...
pss<-plot.parent.reps(pattern="^parent_supergene_\\d+_summary.txt",cols)
```
...
s<-plot.pc.reps("^parent-courter_supergene_\\d+_summary.txt",cols)
```
