...
However, when males are allowed to mate multiply, the results are as predicted and only the courter/parent morph is retained in the population (Fig. \@ref(fig:polyCourterRS)).
...
The answers to these three questions seem to be somewhat linked. First, I 
