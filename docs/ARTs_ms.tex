...
\begin{figure}[H]
\includegraphics[width=40in,]{../figs/frequency_dependence} \caption{Diagram of the mathematical model describing the inheritance of alternative male reproductive morphs given courtship and parenting traits.}\label{fig:unnamed-chunk-1}
\end{figure}
