...
\begin{figure}[H]
\includegraphics[width=0.5px,]{../figs/frequency_dependence} \caption{Diagram of the mathematical model describing the inheritance of alternative male reproductive morphs given courtship and parenting traits.}\label{fig:mathModel}
\end{figure}
