...
<!--# R2:  Does the model assume that the courter male provides parental care to the offspring produced as a result of fertilization by a sneak male? How is the fractional contribution of courters:sneakers modeled in the analysis? -->

## Stage 4: Viability selection

<!--# R2: Lines 234 – 235. I might be missing something, but if two traits are independent how can a trade-off emerge between them? There has to be some constraint built into the model that results in the trade-off. -->We
assumed viability selection only affects male offspring, through a
...
<!--# R1: First and only mention of "carrying capacity". Perhaps give more details on how this was specified and how it related to viability selection. -->
...
chromosome, or 50% of a chromosome.
<!--# R2: Are these reasonable values for the size of supergenes? --> In
all cases, a chromosome was comprised of 1000 loci (including marker
loci and QTLs).
...
<!--# R1: does this represent multiple independent origins to the morphs? -->
...
real-world examples, however, and
<!--#  R2: The sentence ends abruptly, what's missing?--> These
additional forms of complexity in genetic architectures are fruitful
areas for future research. For example, the steroid hormone receptor
