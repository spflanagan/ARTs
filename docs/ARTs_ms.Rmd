...
A striking difference between the analytical model and the simple simulation model is that only two morphs are maintained with parameters that retained three morphs in the analytical model (Fig. \@ref(fig:ternaryPlots)A). Furthermore, stochasticity played a major role in which
