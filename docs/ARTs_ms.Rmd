...
*Add some info about balancing selection and fitness and reference the supplement*
...
\@ref(fig:architectureTernary)). The finding the parent QTLs are more likely
...
S4) -- mutations could have cropped up that
