...
[@lagunas-roblesLinkedSupergenesUnderlie2021]). We performed these
analyses on simulated genome-wide data, and found that genome-wide
association studies are likely to only identify $\le$ 50% of true QTLs,
and identify many false positives. Low true positives and high false
positives are consistent with other simulation studies of genome-wide
studies of selection and trait associations
