...
and ruff supergenes [@maneySupergenesSteroids2022] would be better
...
modelled by [@svenssonFemalePolymorphismFrequency2005]), and could even
...
variation [@flanaganIdentifyingSignaturesSexual2015], our models predict
the maintenance of variation in phenotypes and in genotypes.
Additionally, we detected high levels of genetic differentiation between
male types, even without strong selection, which is opposite to the
predictions for sex-specific selection
...
(https://github.com/spflanagan/ARTs). 
Outputs used in the creation of figures in the main text and the supplement are archived on zenodo (DOI: ).
