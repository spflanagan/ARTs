...
each morph, as has been reported in [examples]. A striking difference in
our results from those of the empirical ones -- in particular, the
empirical results relating to supergenes -- is that we do not see fixed
alleles exclusively in one morph of the other. Instead, quantitative
variation is retained within the supergenes, and we do not observe
discrete haplotypes underlying the categorical morphs. To some extent,
this is likely an artefact of our model set-up. In empirical examples, a
key gene substantially contributes to the phenotypic morph, for example
the steroid hormone receptor genes in white-throated sparrows and ruffs
...
(e.g., modelled as such by X), and could even be underpinned by
dominance reversals between morphs
...
architectures. As expected, linkage disequilibrium was elevated within
the supergene region, and similarly high levels of LD were not observed
in the genome-wide QTL models. However, measures of genetic variation
and between-morph differentiation were similar in the two types of
models.
