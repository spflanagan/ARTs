...
of sexual dimorphism. Across a wide range of taxa, multiple discrete
alternative reproductive tactics are frequently maintained, in which
individuals of the same species and sex display different morphs to
maximize reproductive fitness in unique ways
...
side-blotched lizards [@alonzoMateChoiceGames2001]), and partitioning of
reproductive success over time (e.g., the feminized dwarf spider morph
mates earlier, whereas the alternative morph is able to mate with
previously-mated females later in the season
...
non-courters/non-parents. Our model can be generalized to any species in
which one sex (but not the other) has two traits that impact mating
success and the survival of their offspring.
