...
at birth, and therefore are primarily genetically determined (e.g.,
examples).
...
maintenance. Evolution can be constrained by factors including
...
[@morrisIntralocusTacticalConflict2013]. Yet, other work on traits such
as these that are critical to reproductive fitness suggest that traits
are determined by the additive contributions of many loci throughout the
genome [@slyMolecularParallelismSignaling2022;
@flanaganGenomewideSelectionComponents2017].
...
deviation of $sigma_\mu$. Finally, offspring were also randomly assigned
a sex.
