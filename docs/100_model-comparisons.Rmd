...
```{r highDivGenetics}
highDivQ<-get.morph.freqs(plot.pc.reps(pattern="highDiversity.*monogamy_nm_q1_.*summary.txt",path="../fixedART-results/qtls/",cols,make.plot=FALSE))
highDivS<-get.morph.freqs(plot.pc.reps(pattern="highDiversity.*monogamy_nm_.*_q1_.*summary.txt",path="../fixedART-results/supergene/",cols,make.plot=FALSE))
