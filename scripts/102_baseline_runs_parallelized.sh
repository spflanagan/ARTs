...
for i in `seq ${NUMREPS}`; do
    ...
    if [ "$NO_GENETICS" = true ]; then
        ...
        if [ "$INDEP_PREF" = true ]; then
            ...
            ((ii=ii%N)); ((ii++==0)) && wait; ./ARTs --courter --no-genetics --independent-pref --parent -b ../../results/parent-courter-pref-nogenetics_${i} --verbose --viability --same-base -p 4 &
        fi
        if [ "$FDS_PREF" = true ]; then
            ((ii=ii%N)); ((ii++==0)) && wait; ./ARTs --courter --no-genetics --freq-dependent-preference -b ../../results/courter-nogenetics-nfds_${i} --verbose --viability -p 4 &
            ((ii=ii%N)); ((ii++==0)) && wait; ./ARTs --parent --no-genetics --freq-dependent-preference -b ../../results/parent-nogenetics-nfds_${i} --verbose --viability -p 4 &
            ((ii=ii%N)); ((ii++==0)) && wait; ./ARTs --courter --no-genetics --parent --freq-dependent-preference -b ../../results/parent-courter-nogenetics-nfds_${i} --verbose --viability -p 4 &
        fi
    fi
    ...
    if [ "$GENETIC_ARCH" = true ]; then
        ...
        if [ "$INDEP_PREF" = true ]; then
            ((ii=ii%N)); ((ii++==0)) && wait; ./ARTs --courter --independent-pref -b ../../results/courter-pref_${i} --verbose --viability -p 4 &
            ((ii=ii%N)); ((ii++==0)) && wait; ./ARTs --parent --independent-pref -b ../../results/parent-pref_${i} --verbose --viability -p 4 &
            ((ii=ii%N)); ((ii++==0)) && wait; ./ARTs --courter --independent-pref --parent -b ../../results/parent-courter-pref_${i} --verbose --viability -p 4 &
        fi
    fi
    ...
    if [ "$SUPERGENE" = true ]; then
        ...
        if [ "$FDS_PREF" = true ]; then
            ...
            ((ii=ii%N)); ((ii++==0)) && wait; ./ARTs --courter --parent --supergene --freq-dependent-preference -b ../../results/parent-courter_supergene_nfds_${i} --verbose --viability -p 4 &
        fi
        if [ "$INDEP_PREF" = true ]; then
            ((ii=ii%N)); ((ii++==0)) && wait; ./ARTs --courter --independent-pref --supergene -b ../../results/courter-pref_supergene_${i} --verbose --viability -p 4 &
            ((ii=ii%N)); ((ii++==0)) && wait; ./ARTs --parent --independent-pref --supergene -b ../../results/parent-pref_supergene_${i} --verbose --viability -p 4 &
            ((ii=ii%N)); ((ii++==0)) && wait; ./ARTs --courter --independent-pref --supergene --parent -b ../../results/parent-courter-pref_supergene_${i} --verbose --viability -p 4 &
        fi  
    fi
